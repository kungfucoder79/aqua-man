...
namespace Aqua_Control
{
    ...
    public class AquaI2CController : IAquaI2CController
    {
        ...
        public double GetWaterHeight()
        {
            ...
            FinalCapMeasure1 = ReadCapSen1_1(Meas1AddrBufLSB[0], Meas1AddrBufMSB[0]);
            FinalCapMeasure2 = ReadCapSen1_1(Meas2AddrBufLSB[0], Meas2AddrBufMSB[0]);
            FinalCapMeasure3 = ReadCapSen1_1(Meas3AddrBufLSB[0], Meas3AddrBufMSB[0]);
        ...
        private void InitI2C()
        {
            ...
            I2CSensor = Pi.I2C.AddDevice(0x20);
        ...
        private float ReadCapSen1_1(int RegAddrBuf1, int RegAddrBuf2)
        {
            ...
            ReadBuf1[0] = I2CSensor.ReadAddressByte(RegAddrBuf1);
            ReadBuf2[0] = I2CSensor.ReadAddressByte(RegAddrBuf2);
